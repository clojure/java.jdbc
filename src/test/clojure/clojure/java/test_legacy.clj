...
;;  0.5.0 as a sanity check to make sure I don't break existing functionality
;;  while I deprecate and reorganize various functions.
;;
;;  scgilardi (gmail)
...
(defn- test-specs
  ...
  (for [db test-databases]
    @(ns-resolve 'clojure.java.test-legacy (symbol (str (name db) "-db")))))
